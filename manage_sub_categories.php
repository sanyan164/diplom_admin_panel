...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Подкатегории</strong><small> Форма</small></div>
                        <form method="post">
							<div class="card-body card-block">
							   <div class="form-group">
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">Подкатегория</label>
									<input type="text" name="sub_categories" placeholder="Введите подкатегорию" class="form-control" required value="<?php echo $sub_categories?>">
								</div>
