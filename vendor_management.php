	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title"> Аккауты сотрудников</h4>
				   <h4 class="box-link"><a href="manage_vendor_management.php">Добавить сотрудника</a> </h4>
				</div>
				<div class="card-body--">
					  ...
					  <table class="table ">
						 <thead>
							<tr>
							   <th class="serial">#</th>
							   <th width="2%">ID</th>
							   <th width="20%">Название аккаунта</th>
