	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">Продукты</h4>
				   <h4 class="box-link"><a href="manage_product.php">Добавить продукт</a> </h4>
				</div>
				<div class="card-body--">
					  ...
					  <table class="table ">
						 <thead>
							<tr>
							   ...
							   <th width="6%">MRP</th>
							   <th width="7%">Цена</th>
							   <th width="12%">Количество штук и статус</th>
							   <th width="25%">Изменения</th>
							</tr>
						 </thead>
						 <tbody>
							<?php 
