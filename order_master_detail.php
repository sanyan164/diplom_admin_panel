	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title"> Подробнее о заказе </h4>
				</div>
				<div class="card-body--">
				   <div class="table-stats order-table ov-h">
					  <table class="table">
								<thead>
									<tr>
										<th class="product-thumbnail">Название продукта</th>
										<th class="product-thumbnail">Изображение продукта</th>
										<th class="product-name">Кол-во</th>
										<th class="product-price">Цена</th>
										<th class="product-price">Финальная цена</th>
									</tr>
								</thead>
								<tbody>
									<?php
									...
									<tr>
										<td colspan="3"></td>
										<td class="product-name">Купон</td>
