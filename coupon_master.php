	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">Редактирование купонов</h4>
				   <h4 class="box-link"><a href="manage_coupon_master.php">Добавить купон</a> </h4>
				</div>
				<div class="card-body--">
					  ...
					  <table class="table ">
						 <thead>
							<tr>
							   ...
							   <th width="20%">Тип купона</th>
							   <th width="10%">Мин сумма для работы</th>
							   <th width="26%"></th>
							</tr>
						 </thead>
						 <tbody>
